...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException 
	{
		...
		if (colonIndex < 0)
			throw new TreeException("Invalid"); //throw a TreeException with a useful message
		...
		else
		{
			...
			if (parentNode == null) {
				throw new TreeException("Nah fam");
			}
		...
		for (int i = 0; i < childrenArray.length; i++) {
			TreeNode name = new TreeNode(childrenArray[i]);
